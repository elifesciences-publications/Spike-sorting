function [coeff, score, latent, tsquare] = ybs_princomp(x,econFlag)

% The only difference from the original matlab function is that i do not
...
x0 = x; % This is the part I changed - Yoram ...
