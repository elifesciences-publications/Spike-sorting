...
% datestr    = '13jun08'; site = 1; % sorted, spk and source files deleted
...
% datestr    = '20may08'; site = 1;  % preprocessed suorce files deleted 


% datestr    = '08may08'; site = 1;   % preprocessed suorce files deleted 

% classified two shanks in 05may site 1, two more to go
% datestr    = '05may08'; site = 1; % Done, source and spk files deleted
...
% datestr    = '30apr08'; site = 1; % done source and spk files deleted
% datestr    = '30apr08'; site = 2; % preprocesssed source deleted
% datestr    = '24apr08'; site = 1; % Done source and spk files deleted
% datestr    = '24apr08'; site = 2; % preprocesssed source deleted
% datestr    = '22apr08'; site = 1; % Done source and spk files deleted
% datestr    = '18apr08'; site = 1; % preprocessed, source deleted
% datestr    = '15apr08'; site = 1; % Done source and spk files deleted
% datestr    = '03apr08'; site = 1; % preprocessed source deleted
% datestr    = '01apr08'; site = 1; % preprocessed source deleted
% datestr    = '28mar08'; site = 1; % preprocessed source deleted
% datestr    = '27mar08'; site = 1; % preprocessed source deleted
% datestr    = '25mar08'; site = 1; % Done source and spk files deleted
% datestr    = '20mar08'; site = 1; % Done source and spk files deleted




% datestr  = '07mar08'; site = 1; % Done source deleted
% datestr  = '29feb08'; site = 1; % Done source and single chan spk files deleted
% datestr  = '06mar08'; site = 1; % Done source and single chan spk files deleted
% datestr  = '28feb08'; site = 1; % Done source and single chan spk files deleted
% datestr  = '05mar08'; site = 1; % Done source and single chan spk files deleted
% datestr  = '07feb08'; site = 1; % Done source and single chan spk files deleted
% datestr  = '15feb08'; site = 2; % Done source and single chan spk files deleted
% datestr  = '15feb08'; site = 1; % Done source and single chan spk files deleted
% datestr  = '19feb08'; site = 1; % Done source and single chan spk files deleted
% datestr  = '08feb08'; site = 1; % Done source and single chan spk files deleted
% datestr  = '29jan08'; site = 1; % Done source and single chan spk files deleted
% datestr  = '31jan08'; site = 1; % Done source and single chan spk files deleted
% datestr  = '01feb08'; site = 1; % Done source and single chan spk files deleted


%datestr  = '17nov06'; site = 1;
%datestr  = '18jan07';
%datestr  = '11jan07'; site = 1;
...
% pre process tasks
CHECK    = 1; % Check for data completeness - relevant when TDT messes up
DETECT   = 1; % Detect spike times
    ...
    % in the process.  
EXTRACT  = 1; % Extract waveforms
PCS      = 1; % Calculate primciple components
