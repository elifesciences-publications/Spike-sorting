...
% SELECT_CHANNELS M-file for select_channels.fig
...
%      applied to the GUI before select_channels_OpeningFunction gets called.  An
...
% Last Modified by GUIDE v2.5 31-May-2005 19:21:47
...
% uiwait(handles.select_channels);
...
% --- Executes on button press in echeck7.
function echeck7_Callback(hObject, eventdata, handles)
% hObject    handle to echeck7 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of echeck7


% --- Executes on button press in echeck8.
function echeck8_Callback(hObject, eventdata, handles)
% hObject    handle to echeck8 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of echeck8


% --- Executes on button press in echeck9.
function echeck9_Callback(hObject, eventdata, handles)
% hObject    handle to echeck9 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of echeck9


% --- Executes on button press in echeck10.
function echeck10_Callback(hObject, eventdata, handles)
% hObject    handle to echeck10 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of echeck10
