function    plot_spikes(spike_times,spike_trials,timevec,event_times,event_trials,event_names,prev_event_times,prev_event_trials,prev_event_names,overlap,u_name,block_tag,ntrials,DD,PSTH,axes_handles,legend_on);
% plot_spikes
...
if DD
    ...
    Y(1,:) = ntrials - spike_trials-0.3;
    Y(2,:) = ntrials - spike_trials+0.3;
    Y(3,:) = nan(1,length(Y));
