...
for i = 1:length(long_names)
    ...
    elseif strcmp(long_names{i},'inhale Est Female urine_1F_2ul')
        short_names{i} = 'Inh E-FU';
    elseif strcmp(long_names{i},  'inhale Feale urine_1F_2ul')
        short_names{i} = 'Inh FU';        
    elseif strcmp(long_names{i},  'inhale Female urine_1F_2ul')
        short_names{i} = 'Inh FU';        
    elseif strcmp(long_names{i},  'inhale Male Urine_1F_2ul')
        short_names{i} = 'Inh MU';
    elseif strcmp(long_names{i},  'inhale Predator urine_1F_2ul')
        short_names{i} = 'Inh PU';
    elseif strcmp(long_names{i},'*VNS* BC Est Female Urine_100F_2ul')
        short_names{i} = 'VNS BC E-FU';
    elseif strcmp(long_names{i},'*VNS* BC Female Urine_100F_2ul')
        short_names{i} = 'VNS BC FU';
    elseif strcmp(long_names{i}, '*VNS* BC Male Urine_100F_2ul')
        short_names{i} = 'VNS BC MU';
    elseif strcmp(long_names{i},'*VNS* C57 Est Female Urine_100F_2ul')
        short_names{i} = 'VNS C57 E-FU';
    elseif strcmp(long_names{i},'*VNS* C57 Female Urine_100F_2ul')
        short_names{i} = 'VNS C57 FU';
    elseif strcmp(long_names{i}, '*VNS* C57 Male Urine_100F_2ul')
        short_names{i} = 'VNS C57 MU';
    elseif strcmp(long_names{i},'*VNS* CBA Est Female Urine_100F_2ul')
        short_names{i} = 'VNS CBA E-FU';
    elseif strcmp(long_names{i},'*VNS* CBA Female Urine_100F_2ul')
        short_names{i} = 'VNS CBA FU';
    elseif strcmp(long_names{i}, '*VNS* CBA Male Urine_100F_2ul')
        short_names{i} = 'VNS CBA MU';
    elseif strcmp(long_names{i},  '*VNS* Predator Urine_100F_2ul')
        short_names{i} = 'VNS PU';
    elseif strcmp(long_names{i}, '*VNS* Est Female Urine_100F_2ul')
        short_names{i} = 'VNS E-FU';
    elseif strcmp(long_names{i},'*VNS* Female Urine_100F_2ul')
        short_names{i} = 'VNS FU';    
    elseif strcmp(long_names{i},'*VNS* Male Urine_100F_2ul')
        short_names{i} = 'VNS MU';                
    ...
    elseif strcmp('*MOS* Male Urine_10F_2ul',long_names{i})
        short_names{i} = ['MOS-M_U_10F_x'];                  
    elseif strcmp('*MOS* Predator Urine_10F_2ul',long_names{i})
        short_names{i} = ['MOS-P_U_10F_x'];                            
    elseif strcmp('*MOS* Female Urine_10F_2ul',long_names{i})
        short_names{i} = ['MOS-F_U_10F_x'];
    elseif strcmp('*MOS* Predator Urine_100F_2ul',long_names{i})
        short_names{i} = ['MOS-P_U_100F_x'];
    elseif strcmp('*MOS* Female Urine_100F_2ul',long_names{i})
        short_names{i} = ['MOS-F_U_100F_x'];
    elseif strcmp('*MOS* Male Urine_100F_2ul',long_names{i})
        short_names{i} = ['MOS-M_U_100F_x'];
